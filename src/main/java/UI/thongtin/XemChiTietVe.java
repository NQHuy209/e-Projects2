...
public class XemChiTietVe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/icons/tickets1.png"))); // NOI18N
        jLabel1.setText("Thông Tin Vé Bán");
        jLabel1.setVerticalAlignment(javax.swing.SwingConstants.TOP);

        jLabel2.setText("Mã Vé Bán");

        jLabel3.setText("Tên Phim");

        jLabel4.setText("Giờ Chiếu");

        jLabel5.setText("Mã Vé Bán");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XemChiTietVe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new XemChiTietVe().setVisible(true);
            }
        });
    }
